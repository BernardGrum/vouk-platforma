        ...
        <div>
          <div className="mb-4">
            ...
            <input 
              type="email" 
              id="email"
              className="block w-full border border-neutral-300 rounded-md shadow-sm p-2.5 focus:ring-2 focus:ring-primary-500 transition"
              placeholder="npr. ime.prezime@email.com"
              value={email}
          ...
          <div className="mb-6">
            <label className="flex items-center">
              ...
              <span className="ml-2 text-sm text-neutral-600">
                Slažem se s <a href="#" className="underline text-primary-600">Uvjetima korištenja</a> i <a href="#" className="underline text-primary-600">Politikom privatnosti</a>.
              </span>
            </label>
          </div>
          <div className="flex flex-col items-center space-y-3">
            ...
            <div className="w-full flex items-center my-2">
                ...
                <span className="flex-shrink mx-4 text-neutral-500 text-sm">ili</span>
                <div className="flex-grow border-t border-neutral-300"></div>
            </div>
